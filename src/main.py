...
# 教师管理路由
app.add_api_route("/api/exam/teacher/login", teacher_login, methods=["POST"])
app.add_api_route("/api/exam/teacher/stats", get_teacher_stats, methods=["GET"])
app.add_api_route("/teacher", get_teacher_page, methods=["GET"])
